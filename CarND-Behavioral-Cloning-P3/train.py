...
def geneartor(samples, batch_size=32, is_train=False):
...
train_generator = geneartor(train_samples, batch_size=32, is_train=True)
validation_generator = geneartor(validation_samples, batch_size=32)
test_generator = geneartor(test_samples, batch_size=32)

...
After the collection process, I had X number of data points. When the model takes the image, it first crops the image by leaving only the road part, and then normalizes the image pixel into value between [-0.5, 0.5]
